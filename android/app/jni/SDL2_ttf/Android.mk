...
PLUTOSVG_LIBRARY_PATH = externalplutosvg
PLUTOVG_LIBRARY_PATH = externalplutovg

# Enable this if you want to use HarfBuzz
SUPPORT_HARFBUZZ = true
HARFBUZZ_LIBRARY_PATH = externalharfbuzz

FREETYPE_LIBRARY_PATH = externalfreetype
...
LOCAL_SRC_FILES = 
	srcSDL_ttf.c.neon 
	srcSDL_hashtable.c 
	srcSDL_hashtable_ttf.c 
	srcSDL_gpu_textengine.c 
	srcSDL_renderer_textengine.c 
	srcSDL_surface_textengine.c

LOCAL_C_INCLUDES += $(LOCAL_PATH)include

LOCAL_CFLAGS += -O2

LOCAL_LDFLAGS = -Wl,--no-undefined -Wl,--version-script=$(LOCAL_PATH)srcSDL_ttf.sym
...
ifeq ($(SUPPORT_PLUTOSVG),true)
    ...
    LOCAL_SRC_FILES += 
        externalplutosvgsourceplutosvg.c 
        externalplutovgsourceplutovg-blend.c 
        externalplutovgsourceplutovg-canvas.c 
        externalplutovgsourceplutovg-font.c 
        externalplutovgsourceplutovg-ft-math.c 
        externalplutovgsourceplutovg-ft-raster.c 
        externalplutovgsourceplutovg-ft-stroker.c 
        externalplutovgsourceplutovg-matrix.c 
        externalplutovgsourceplutovg-paint.c 
        externalplutovgsourceplutovg-path.c 
        externalplutovgsourceplutovg-rasterize.c 
        externalplutovgsourceplutovg-surface.c
endif
