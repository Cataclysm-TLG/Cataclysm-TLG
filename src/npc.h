...
const std::unordered_map<std::string, ally_rule_data> ally_rule_strs = { {
        ...
        {
            "use_climate_control", {
                ally_rule::use_climate_control,
                "<ally_rule_use_climate_control_true_text>",
                "<ally_rule_use_climate_control_false_text>"
            }
        }
    }
};
...
class npc : public Character
{
    ...
    public:
        ...
        */
        ...
        bool try_use_climate_control_devices();
