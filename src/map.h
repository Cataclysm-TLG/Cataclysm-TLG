...
class map
{
    ...
    public:
        ...
        */
        ...
        int move_cost( const tripoint &p, const vehicle *ignored_vehicle = nullptr, const bool ignore_fields = false ) const;
        int move_cost( const tripoint_bub_ms &p, const vehicle *ignored_vehicle = nullptr, const bool ignore_fields = false ) const;
        int move_cost( const point_bub_ms &p, const vehicle *ignored_vehicle = nullptr, const bool ignore_fields = false ) const {
        ...
        */
        int combined_movecost( const tripoint_bub_ms &from, const tripoint_bub_ms &to,
                               ...
                               int modifier = 0, bool flying = false, bool via_ramp = false, const bool ignore_fields = false ) const;
