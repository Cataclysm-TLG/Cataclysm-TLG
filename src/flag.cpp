...
const flag_id flag_ALLERGEN_vegetable( "ALLERGEN_vegetable" );
...
const flag_id flag_CROSSBOW( "CROSSBOW" );
...
const flag_id flag_DECAYS( "DECAYS" );
...
const flag_id flag_REPLICA_EQUIPMENT( "REPLICA_EQUIPMENT" );
...
const flag_id flag_PARENT_REQUIRED( "PARENT_REQUIRED" );
